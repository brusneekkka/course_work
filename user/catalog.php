      ...
      <div class="row">
        ...
        <div class="col-sm-4 offset-md-1 py-5">
          ...
          <ul class="list-unstyled">
            <p></p>
            <p></p>
            <!--<li><a href="#" class="text-white">Показать на Карте</a></li>-->
      ...
      <div class="col-lg-6 col-md-8 mx-auto">
        ...
        <p>
            <div class="input-group mb-3">
              ...
              <!--<button id="xxx" class="btn btn-outline-primary my-4 mx-2" type="button" id="button-addon2">Заказать</button>
              <button type="button" class="btn btn-secondary my-2" data-bs-toggle="modal" data-bs-target="#exampleModal">
              Ваши заказы
            </button>-->
            </div>
          <script>
